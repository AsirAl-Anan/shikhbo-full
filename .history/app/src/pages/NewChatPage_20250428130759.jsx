...
function NewChatPage() {
  ...
  // Check for and use query from ChatModal
  useEffect(() => {
    if (location.pathname === "/new") {
      const storedQuery = sessionStorage.getItem('chatModalQuery');
      if (storedQuery) {
        setInputValue(storedQuery);
        // Remove the stored query after using it
        sessionStorage.removeItem('chatModalQuery');
  ...
  }, [paramChatId]); // Removed navigate dependency, as it was causing unnecessary reconnects
