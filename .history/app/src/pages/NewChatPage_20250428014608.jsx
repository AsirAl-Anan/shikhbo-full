...
function NewChatPage() {
 ...
 const navigate = useNavigate();
  ...
  const { id: paramChatId } = useParams(); // Get chatId from URL params
  console.log("paramChatId",paramChatId)
  useEffect(() => {
    if (paramChatId) {
      // 🛠 Fetch existing chat if paramChatId is present
      const fetchChat = async () => {
        try {
          const res = await axios.post(`/ai/chat/getChat`, {chatId: paramChatId}, {withCredentials: true});
