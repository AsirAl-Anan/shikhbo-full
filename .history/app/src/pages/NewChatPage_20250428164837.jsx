...
function NewChatPage() {
 ...
 // Add this to your existing socket connection setup
useEffect(() => {
  ...
  // Add more verbose logging for all socket events
  socketRef.current.on("chatStarted", (data) => {
    console.log("chatStarted event received:", data);
  ...
  socketRef.current.on("messageReceived", (data) => {
    console.log("messageReceived event received:", data);
    // Your existing code here
  });
  ...
  socketRef.current.on("error", (data) => {
    ...
    setIsTyping(false);
    // Consider displaying an error toast/notification to the user
  });

  // Add catch-all event listener to see ALL events
