...
const ChatInput = ({ onClick }) => {
  return (
    <div className="w-full">
      <button onClick={onClick} className="w-full bg-gray-800 rounded-full py-3 px-4 flex items-center text-gray-400">
        <svg
        ...
        <span className="flex-1 text-left">Asko anything</span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-6 w-6"
          fill="none"
