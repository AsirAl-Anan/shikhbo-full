/*************  ✨ Windsurf Command ⭐  *************/
/**
 * Renders a chat message component based on the user's role.
 *
 * @param {Object} props - The component props.
 * @param {Object} props.message - The message object containing details of the chat message.
 * @param {string} props.message.role - The role of the sender, either "user" or "ai".
 * @param {string} props.message.content - The text content of the message.
 * @param {string} [props.message.image] - Optional image associated with the message.
 *
 * @returns {JSX.Element} A styled chat message component with text and optional image.
 */

/*******  9b2064c2-d8d2-4c71-a628-b2e12488384c  *******/import React, { useState, useRef, useEffect } from 'react';
