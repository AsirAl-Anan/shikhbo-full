  ...
  return (
    <div className="group my-[20px]">
      <div className="relative mb-2 bg-gray-700 rounded-lg overflow-hidden">
        <div className="w-full mt-5 p-4">{stem[0]}</div>
 
        {question.badge && (
          <div className="absolute top-1 left-4 uppercase text-xs font-bold tracking-wider text-white bg-gray-900 bg-opacity-70 px-2 py-1 rounded">
            {question.badge}
          </div>
        )}
      </div>
