          ...
          {automations.map((automation) => (
            ...
            >  
              <div className="flex items-center mb-2">
                ...
                <h3 className="font-medium text-sm md:text-base">{automation.title}</h3>{ automation.ti    <span className="ml-2  px-1 py-0.5 rounded-sm bg-pink-500 text-white font-medium text-opacity-90 text-xs">soon</span>}
              </div>
