    ...
    <div className={`w-64 flex flex-col h-full ${(!isSidebarOpen && !isMobile) ? 'invisible' : 'visible'}`}>
      ...
      <nav className="p-4 space-y-6 flex-1 overflow-y-auto">
        ...
        <div className="space-y-2">
          ...
          <NavLink   className={ "flex items-center space-x-2 p-2 text-gray-300 hover:text-white hover:bg-gray-800 rounded-md"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
              fill="none"
            ...
            <span className="flex items-center">
              Exam Generator
              <span className="ml-2 text-xs px-1 py-0.5 rounded-sm bg-pink-500 text-white font-medium text-opacity-90 text-xs">soon</span>
            </span>
          </NavLink>
          ...
          <NavLink to="/inbox" onClick={()=>showNewFeatureAlert()} className={"flex items-center space-x-2 p-2 text-gray-300 hover:text-white hover:bg-gray-800 rounded-md"
          }>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
