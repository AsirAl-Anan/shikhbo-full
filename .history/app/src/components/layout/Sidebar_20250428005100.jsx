...
const Sidebar = ({ isSidebarOpen, isMobile, toggleSidebar, currentUser }) => {
  ...
  useEffect(() => {
    const getchatChats = async () => {
      try {
        ...
        setChatResponse(response.data.chats);  // Set the state here with the resolved data
      } catch (error) {
  ...
  console.log("chats", chats); // This will log the updated value of chats after it's set
