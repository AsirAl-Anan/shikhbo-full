        ...
        <nav className="p-4 space-y-6 flex-1 overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            <NavLink to="/exam" className={({isActive}) => 
              isActive 
                ? "flex items-center justify-between p-2 rounded-md bg-gradient-to-r from-blue-600 to-indigo-700 text-white"
                : "flex items-center justify-between p-2 text-gray-300 hover:text-white hover:bg-gray-800 rounded-md"
            }>
              ...
              <span className="text-xs px-2 py-1 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 text-white font-semibold">Coming soon</span>
            </NavLink>
